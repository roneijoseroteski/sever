...
var PegaMinhasOsAction = /** @class */ (function (_super) {
    ...
    PegaMinhasOsAction.prototype.pegaOS = function () {
        return 'select ordemServico.idOrdemServico,ordemServico.resumo,DATE_FORMAT(ordemServico.inicioPlanejado, "%d/%m/%Y") AS inicioPlanejado,DATE_FORMAT(ordemServico.fimPlanejado, "%d/%m/%Y") AS fimPlanejado , ordemServico.Status_idStatus  from ordemServico where Usuario_idUsuario =\'' + 1 + '\'';
        console.log('entrou');
    };
