...
var OrdemServicoAction = /** @class */ (function (_super) {
    __extends(OrdemServicoAction, _super);
    function OrdemServicoAction() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    OrdemServicoAction.prototype.ordemServico = function () {
    ...
    OrdemServicoAction.prototype.ordemServico1 = function () {
    ...
    OrdemServicoAction.prototype.ordemServico2 = function () {
    ...
    OrdemServicoAction.prototype.OrdemServico = function () {
        ...
        new mysql_factory_1.MySQLFactory().getConnection().select(ordemServico).subscribe(function (data) {
    ...
    OrdemServicoAction.prototype.defineVisibility = function () {
        this.actionEscope = route_types_1.ActionType.atPublic;
    };
    __decorate([
        decorators_1.Post('/ordemservico'),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
        __metadata("design:returntype", void 0)
    ], OrdemServicoAction.prototype, "OrdemServico", null);
    return OrdemServicoAction;
}(action_1.Action));
exports.OrdemServicoAction = OrdemServicoAction;
